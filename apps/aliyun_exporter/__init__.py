...
from apps.aliyun_exporter.collector import AliyunCollector, CollectorConfig
from apps.aliyun_exporter.web import create_app
...
def aliyun_exporter(config, port=9525):
    ...
    logging.info("Start exporter, listen on {}".format(int(port)))
